...
def main():
    st.markdown(
        "## Government Blockchain System: Land Registry and Citizen Identity - By Sugoto Basu"
    )

    # Create tabs for land registry and adding identity with updated labels.
    tabs = st.sidebar.radio("Choose an Action", ("Land Registry", "Citizen Identity"))
